...
public class ListProject extends ListActivity {
    ...
    private static final String url_all_projects = "http://projectbux.000webhostapp.com/androidDBMS/listProject.php";
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                String url = ((TextView) view.findViewById(R.id.url)).getText()
                        .toString();
                Intent intent = new Intent(ListProject.this, ProjectBox.class);
    ...
    class LoadAllProjects extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(ListProject.this);
        ...
        protected String doInBackground(String... args) {
            ...
            JSONObject json = jParser.makeHttpRequest(url_all_projects, "GET", params);
        ...
        protected void onPostExecute(String file_url) {
            ...
            Toast.makeText(ListProject.this,"No projects are present in the database...", Toast.LENGTH_SHORT).show();
        }
        }
    }
